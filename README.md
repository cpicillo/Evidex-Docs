...
3. **Risks are identified** and systematically extracted from approved assessments
4. **Decisions are made** to accept, mitigate, transfer, or avoid risk
5. **Approved risks enter the Risk Register** as the system of record
6. **All actions are logged** for audit and review

AI outputs are never finalized or acted upon without explicit human review and approval..
...
* Traceable to a specific model and user
* Reversible by humans

This creates a **defensible AI audit trail** by design.
