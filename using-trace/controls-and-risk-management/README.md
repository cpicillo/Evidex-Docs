...
3. Identify risks based on control gaps or dependencies
4. Decide how each risk will be treated
5. Define and approve mitigation measures where required

Each step is intentional and auditable.
...
All controls and risk management activities are linked to:
...
This allows reviewers to trace:

* Why a control exists
* Which risks it addresses
* How those risks were handled
* What safeguards were approved

Without reconstructing context after the fact.

### Guides in This Section

The following guides explain how to manage controls and risks in practice:
